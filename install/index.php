...
function subpage_title($txt) 
{
	...
	echo '<center><img src="'.$path_to_root.'/themes/default/images/logo_codeself.png" width="250" height="50" alt="Logo" />
		</center>';
...
//			break;
		...
		case '6': // final screen
			subpage_title(_('codeself ERP has been installed successsfully.'));
